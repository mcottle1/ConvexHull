...
class Proj2GUI( QMainWindow ):
	...
	def newPoints(self):
		# ptlist = []
		# ptlist.append(QPointF(-0.5757165010496565, -0.26295328877845825))
		# ptlist.append(QPointF(-0.5059392436959678, 0.7171419939372312))
		# ptlist.append(QPointF(-0.09206942572583676, 0.39237642333587686))
		# ptlist.append(QPointF(-0.03601438064458029, 0.17355941961611965))
		# ptlist.append(QPointF(0.16766903629027352, 0.8839991472988542))
		# ptlist.append(QPointF(0.6028321888569212, -0.12199525709869019))
		# ptlist.append(QPointF(0.6263637789670422, -0.7175392057020546))
		# ptlist.append(QPointF(0.6386571469446221, 0.4760493429188637))
		# ptlist.append(QPointF(0.6695597468473207, 0.4455761422951541))
		# ptlist.append(QPointF(0.8148154068293765, -0.23498751020444897))
		# ptlist.append(QPointF(0.3144506161590237, 0.6207505254798558))
		# ptlist.append(QPointF(-0.8171433680872331, 0.52564630604814))
		# ptlist.append(QPointF(-0.6584140349864, -0.091379554144142))
		# ptlist.append(QPointF(0.09374891768207405, 0.3098532017413145))
		# ptlist.append(QPointF(0.67669036290273521, 0.8399914729885428))
